...
int main()
{
    ...
    for (int i = 1; i <= n; i++)
    {
        ...
        outFile << "ID: " << s.SID << endl;
        outFile << "Name: " << s.Name << endl;
        outFile << "Phone: " << s.Phone << endl;
        outFile << "Course: " << s.Course << endl;
        outFile << "Fee: " << s.Fee << endl;
        outFile << "Remarks: " << s.Remarks << endl;
        outFile << "------------------------" << endl;
    }

    outFile.close();

    cout << "\nData saved successfully in Students.txt" << endl;
